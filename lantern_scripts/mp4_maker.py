...
if __name__ == '__main__':
    ...
    out = cv2.VideoWriter(args.out_file, cv2.VideoWriter_fourcc(*'FMP4'), 10, size)
    # out = cv2.VideoWriter('my_apartement_render.mp4', cv2.VideoWriter_fourcc('X','V','I','D'), 15, size)
