...
if __name__ == '__main__':
    ...
    renders_compressed = os.path.join(renders_dir, args.metric_name + "_compressed")
    if os.path.exists(renders_compressed):
        shutil.rmtree(renders_compressed)
